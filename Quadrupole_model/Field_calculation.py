...
class Calculation_field:
    ...
    #Resolution of the linear system
        ...
        n_grid_points = 100
        self.points = np.stack((np.zeros(n_grid_points), np.zeros(n_grid_points), (np.linspace(0, 10*self.data.total_length, n_grid_points)))) #x=y=0 and z changes from 0 to elec_id[7][11]=total_length
