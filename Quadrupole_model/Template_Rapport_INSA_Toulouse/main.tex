...
\begin{titlepage}
    ...
    \begin{minipage}{0.5\textwidth}
        ...
        \includegraphics[width=0.5\linewidth]{images/tescan-logo.jpg} % Ajustez le chemin et la taille
    \end{minipage}


    \vspace*{2cm} % Espace vertical de 2 cm
    {\Huge\bfseries Exemple Rapport \par}
    \vspace{1cm}
    {\huge Sous titre du rapport\par}
    \vspace{2cm}
    {\Large \textbf{Berlioz le Chat} \par}
    \vspace{2cm}
    
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/plume.png}
    \end{figure}
...
\section{Comportements Spécifiques des Chats}
\label{sec:behaviors}
\noindent % Pas d'indentation
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{images/chat_soupis.png}
    \caption{Les chat-soupis}
...
% Insérer l'image avec wrapfigure
\begin{wrapfigure}{r}{0.5\textwidth} % 'r' pour right et '0.5\textwidth' définit la largeur de l'enveloppe
  \centering
  \includegraphics[width=0.48\textwidth]{images/cute_cat.png} % Assurez-vous que l'image est du bon format
  \caption{Chat mignon}
\end{wrapfigure}
...
\begin{figure}[H] % [H] pour Here : spécifie que l'image doit être à cet endroit et pas autre part
    \centering
    \includegraphics[width=0.5\linewidth]{images/chat_pardeur.png}
    \caption{Chat-pardeur}
    \label{fig:enter-label}
\end{figure}
