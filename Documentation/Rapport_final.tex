...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\huge Modélisation d'une lentille électrostatique quadrupolaire par Boundary Element Method\par}
    \vspace{0.5cm}
    {\large {Louise Lammertyn, Zoé Nonon} \par}
    \vspace{2cm}
    
    \vfill
    {\Large \textbf{Institut National des Sciences Appliquées de Toulouse, département de Génie Physique} \par}
    \vspace{1cm}
    {\large \today \par}
\end{titlepage}
