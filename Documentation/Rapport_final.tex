...
%\lstinputlisting[language=python]{../Quadrupole_model/Data_exploitation.ipynb}
...
%\lstinputlisting[language=python]{../Quadrupole_model/Fit_functions.py}

\subsection{Graphs}
%\lstinputlisting[language=python]{../Quadrupole_model/Graphs.py}

\subsection{Multipolar decomposition}
%\lstinputlisting[language=python]{../Quadrupole_model/Multipolar_decomposition.py}

\subsection{Paraxial}
%\lstinputlisting[language=python]{../Quadrupole_model/paraxial.py}
